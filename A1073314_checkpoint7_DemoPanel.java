...
public class A1073314_checkpoint7_DemoPanel extends JPanel {
    ...
    private ArrayList<A1073314_checkpoint7_Block> path;
    //Description : while moving, the target block;
    private A1073314_checkpoint7_Block target;
    public A1073314_checkpoint7_DemoPanel(A1073314_checkpoint7_Player player, ArrayList<A1073314_checkpoint7_Block> obstacle,int scaler,ArrayList<A1073314_checkpoint7_Block> sands){
        ...
        this.sands = sands;
        this.add(player);
        this.path = new ArrayList<A1073314_checkpoint7_Block>();
        this.target = null;
        ...
        /********************************************************************************************
         START OF YOUR CODE
         ********************************************************************************************/
        centerX = mapImg.getWidth(this)/scaler/2;
        centerY = mapImg.getHeight(this)/scaler/2;
    ...
    public void paintComponent(Graphics g){
        ...
        if(!player.getMoving()){
            ...
            // System.out.println("exception target" + target.getX() + " " + target.getY());
            // g.fillRect(mapX + target.getX()*gridLen,mapY + target.getY()*gridLen, gridLen, gridLen);
            color = new Color(0,0,0,64);
            g.setColor(color);
            for(A1073314_checkpoint7_Block x : path){
    ...
    public void setPath(ArrayList<A1073314_checkpoint7_Block> path){
        this.path = path;
    }
    ...
    public void setTarget(A1073314_checkpoint7_Block target){
        this.target = target;
    }
    public A1073314_checkpoint7_Block getTarget(){
        return this.target;
    }
}
